...
package com.mycompany.servidornotificaciones.utilidades;
...
{
	public static void registrarObjetoRemoto(String[] vectorDatosNS, ControladorGestorNotificacionesImpl objRemoto,String idObjetoRemoto) throws ServantNotActive, WrongPolicy, org.omg.CORBA.ORBPackage.InvalidName, AdapterInactive, InvalidName, NotFound, CannotProceed
        {            
